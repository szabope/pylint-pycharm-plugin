# PyLint Pycharm Plugin Changelog
...
- Changelog update - `v2.2.2` by @github-actions[bot] in https://github.com/szabope/pylint-pycharm-plugin/pull/46

## [2.2.2] - 2026-03-29

- Changelog update - `v2.2.1` by @github-actions[bot] in https://github.com/szabope/pylint-pycharm-plugin/pull/44
- Update common to support Idea by @szabope in https://github.com/szabope/pylint-pycharm-plugin/pull/45

## [2.2.1] - 2026-03-28

- Changelog update - `v2.2.0` by @github-actions[bot] in https://github.com/szabope/pylint-pycharm-plugin/pull/41
- Support Intellij 261 by @szabope in https://github.com/szabope/pylint-pycharm-plugin/pull/43
...
- Support for 2025.3 by @szabope in https://github.com/szabope/pylint-pycharm-plugin/pull/32
...
- Support for IU 2025.1.1 by @szabope in https://github.com/szabope/pylint-pycharm-plugin/pull/20
...
- Fix erroneous temp file name generation by @szabope in https://github.com/szabope/pylint-pycharm-plugin/pull/9
- v0.0.4 by @szabope in https://github.com/szabope/pylint-pycharm-plugin/pull/10

## [0.0.3] - 2025-01-21

- add comment about not supporting system-wide pylint installation
- @github-actions made their first contribution in https://github.com/szabope/pylint-pycharm-plugin/pull/3

## [0.0.2] - 2025-01-20

- Basic implementation eligible to replace old plugin by @szabope in https://github.com/szabope/pylint-pycharm-plugin/pull/1
