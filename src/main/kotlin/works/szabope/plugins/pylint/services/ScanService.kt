...
class ScanService(private val project: Project, private val cs: CoroutineScope) {
    ...
    fun scan(targets: Collection<VirtualFile>, configuration: ToolExecutorConfiguration, silent: Boolean = false): List<PylintMessage> =
        cs.future { scanAsync(targets, configuration, silent) }.get()
